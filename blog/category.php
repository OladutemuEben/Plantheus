  ...
  include 'conn.php';
        ...
        $query = mysqli_query($conn, "SELECT * FROM blog_posts where category = '$category' or tag = '$category'  LIMIT 5");
    ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <!-- Blog Entries Column -->
      <div class="col-md-8">
        <h3 class="mt-4 text-bold">Categories found for: <?php echo $cat;?></h3>
          ...
          <div class="card-footer text-muted">
            ...
            <a href="author.php?author=<?php echo $author ?>"><?php echo $rows['author'];?></a>
             ...
             <?php
                    ...
                    echo "<h3 class='mt-4 text-bold' align=center>No Record found</h3>";
                  }
                    ?>
